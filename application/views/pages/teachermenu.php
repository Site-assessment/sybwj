                          ...
                          <div class="sidebar-nav">
                              <div class="nav-canvas">
                                  <ul class="nav nav-pills nav-stacked main-menu">
                                      <li>
                                          <a class="ajax-link" href="<?php echo site_url('index.php/admin/welcome/index');?>" target="main-content">
                                              <i class="glyphicon glyphicon-home"></i><span> 首页</span>
                                          </a>
                                      </li>
                                      <li>
                                          <a class="ajax-link" href="<?php echo site_url('index.php/admin/pannel_form/form_add');?>" target="main-content">
                                              <i class="glyphicon glyphicon-plus"></i><span>新增测试</span>
                                          </a>
                                      </li>
                                      <li>
                                          <a class="ajax-link" href="<?php echo site_url('index.php/admin/pannel_form/form_list');?>" target="main-content">
                                              <i class="glyphicon glyphicon-list"></i><span>测试列表</span>
                                          </a>
                                      </li>
                                       <li>
                                          <a class="ajax-link" href="<?php echo site_url('index.php/admin/pannel_form/form_list');?>" target="main-content">
